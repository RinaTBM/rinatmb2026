      ...
      <div className="container-lux grid gap-8 lg:grid-cols-2 lg:gap-16">
        ...
        <div>
          ...
          <div className="mt-6 rounded-2xl border border-cream-300 bg-white p-5">
            ...
            <button type="button" className="btn-primary mt-5 w-full" disabled={!checkout.ok} onClick={() => { if (checkout.ok) navigateToGenProductFirstCheckout(checkout.url); }}>{checkout.ok ? 'Continue to Checkout' : 'Temporarily unavailable'}</button>
