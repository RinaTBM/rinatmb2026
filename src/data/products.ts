...
export const products: Product[] = [
  ...
  mk({
    id: 'p82',
    slug: 'recovery-stack',
    displayName: 'Recovery Stack: Four-Peptide Tissue Repair & Recovery Blend',
    ...
    longDescription: COMPOUNDED_DISCLAIMER,
    image: IMG_INJECTION,
    imageAlt: 'Amber injection vial for Recovery Stack four-peptide tissue repair and recovery blend',
    providerDisclaimer: COMPOUNDED_DISCLAIMER,
    memberPricingEligible: false,
