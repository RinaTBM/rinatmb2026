...
export const products: Product[] = [
  ...
  mk({ id: 'p101', slug: 'aod-9604', displayName: 'Body Composition Support', shortName: 'Body Composition Support', subtitle: 'Provider-directed wellness support', category: 'weight-management', goals: ['weight-management'], shortDescription: 'A provider-directed body-composition option available after eligibility review.', longDescription: COMPOUNDED_DISCLAIMER, image: IMG_INJECTION, imageAlt: 'Provider-directed body-composition support injection', providerDisclaimer: COMPOUNDED_DISCLAIMER, variants: [{ dosageForm: 'Injection', strength: 'Provider-directed', size: 'Monthly supply', price: 179 }] }),
  ...
  mk({ id: 'p103', slug: 'bpc-157', displayName: 'BPC-157 Recovery', shortName: 'BPC-157 Recovery', subtitle: 'Provider-directed recovery support', category: 'recovery-performance', goals: ['recovery', 'performance'], shortDescription: 'A provider-directed BPC-157 recovery option available after eligibility review.', longDescription: COMPOUNDED_DISCLAIMER, image: IMG_INJECTION, imageAlt: 'Provider-directed BPC-157 recovery injection', providerDisclaimer: COMPOUNDED_DISCLAIMER, variants: [{ dosageForm: 'Injection', strength: 'Provider-directed', size: 'Monthly supply', price: 199 }] }),
