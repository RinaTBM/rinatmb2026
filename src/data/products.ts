...
export const products: Product[] = [
  ...
  mk({
    ...
    slug: 'semaglutide',
    displayName: 'Semaglutide: GLP-1 Weight Management Injection',
    shortName: 'Semaglutide',
    subtitle: 'Provider-directed GLP-1 receptor agonist for appetite regulation and metabolic support',
    category: 'weight-management',
    goals: ['weight-management'],
    shortDescription: 'A provider-directed GLP-1 receptor agonist injection compounded with Vitamin B12 or Glycine, potentially used to support appetite regulation, glucose metabolism, and progressive weight management under clinical supervision.',
    longDescription: WEIGHT_DISCLAIMER,
    image: IMG_INJECTION,
    imageAlt: 'Amber injection vial for Semaglutide GLP-1 weight management injection',
  ...
  mk({
    ...
    slug: 'tirzepatide',
    displayName: 'Tirzepatide: Dual GLP-1/GIP Weight Management Injection',
    shortName: 'Tirzepatide',
    subtitle: 'Provider-directed dual GLP-1 and GIP receptor agonist for appetite and glucose regulation',
    category: 'weight-management',
    goals: ['weight-management'],
    shortDescription: 'A provider-directed dual GLP-1/GIP receptor agonist injection compounded with Vitamin B12 or Glycine, potentially used to support appetite suppression, improved insulin sensitivity, and progressive weight management under clinical supervision.',
    longDescription: WEIGHT_DISCLAIMER,
    image: IMG_INJECTION,
    imageAlt: 'Amber injection vial for Tirzepatide dual GLP-1/GIP weight management injection',
    providerDisclaimer: WEIGHT_DISCLAIMER,
    bestSeller: true,
    memberPricingEligible: false,
    variants: [
  ...
  mk({ id: 'p101', slug: 'aod-9604', displayName: 'AOD-9604: Lipotropic Body-Composition Peptide', shortName: 'AOD-9604', subtitle: 'Provider-directed lipotropic peptide fragment for body-composition support', category: 'weight-management', goals: ['weight-management'], shortDescription: 'A provider-directed AOD-9604 lipotropic peptide injection potentially used to support fat metabolism and body-composition goals under clinical supervision.', longDescription: COMPOUNDED_DISCLAIMER, image: IMG_INJECTION, imageAlt: 'Provider-directed body-composition support injection', providerDisclaimer: COMPOUNDED_DISCLAIMER, variants: [{ dosageForm: 'Injection', strength: 'Provider-directed', size: 'Monthly supply', price: 179 }] }),
  mk({ id: 'p102', slug: 'metabolic-triple', displayName: 'Metabolic Triple: Three-Peptide Metabolic Protocol', shortName: 'Metabolic Triple', subtitle: 'Provider-directed three-component compounded metabolic protocol', category: 'weight-management', goals: ['weight-management'], shortDescription: 'A provider-directed three-component compounded metabolic injection protocol potentially used to support metabolic function, fat oxidation, and body-composition goals under clinical supervision.', longDescription: COMPOUNDED_DISCLAIMER, image: IMG_INJECTION, imageAlt: 'Provider-directed metabolic protocol injection', providerDisclaimer: COMPOUNDED_DISCLAIMER, variants: [{ dosageForm: 'Injection', strength: 'Provider-directed', size: 'Monthly supply', price: 219 }], status: 'future', isVisible: false }),
  mk({ id: 'p103', slug: 'bpc-157', displayName: 'BPC-157: Tissue Recovery & Gut-Health Peptide', shortName: 'BPC-157', subtitle: 'Provider-directed recovery and tissue-support peptide', category: 'recovery-performance', goals: ['recovery', 'performance'], shortDescription: 'A provider-directed BPC-157 peptide injection potentially used to support musculoskeletal recovery, tendon and ligament comfort, gastrointestinal healing, and connective-tissue wellness under clinical supervision.', longDescription: COMPOUNDED_DISCLAIMER, image: IMG_INJECTION, imageAlt: 'Provider-directed BPC-157 recovery injection', providerDisclaimer: COMPOUNDED_DISCLAIMER, variants: [{ dosageForm: 'Injection', strength: 'Provider-directed', size: 'Monthly supply', price: 199 }] }),
  mk({ id: 'p104', slug: 'ghk-cu-minoxidil', displayName: 'GHK-Cu + Minoxidil: Hair & Skin Renewal Topical', shortName: 'GHK-Cu + Minoxidil', subtitle: 'Provider-directed compounded topical for scalp and skin regeneration', category: 'prescription-skin-hair', goals: ['beauty'], shortDescription: 'A provider-directed compounded topical combining GHK-Cu copper peptide and minoxidil, potentially used to support hair follicle stimulation, scalp health, collagen production, and skin renewal under clinical supervision.', longDescription: RX_DISCLAIMER, image: IMG_CREAM, imageAlt: 'Provider-directed topical care', providerDisclaimer: RX_DISCLAIMER, variants: [{ dosageForm: 'Cream', strength: 'Provider-directed', size: 'Monthly supply', price: 69 }] }),
  mk({ id: 'p105', slug: 'ondansetron-odt', displayName: 'Ondansetron ODT: Nausea & GI Support Tablet', shortName: 'Ondansetron ODT', subtitle: 'Provider-directed anti-nausea supportive care for weight-management programs', category: 'weight-management', goals: ['weight-management'], shortDescription: 'A provider-directed orally disintegrating ondansetron tablet potentially used to manage nausea, gastrointestinal discomfort, and medication-related side effects during supervised weight-management therapy.', longDescription: RX_DISCLAIMER, image: IMG_CAPSULE, imageAlt: 'Provider-directed orally disintegrating tablet', providerDisclaimer: RX_DISCLAIMER, variants: [{ dosageForm: 'Orally disintegrating tablet', strength: 'Provider-directed', size: 'Monthly supply', price: 59 }] }),

  // ===== WOMEN'S HORMONE THERAPY =====
  mk({
    id: 'p16', // preserves previous Estrogen Transdermal Patch app_product_id
    slug: 'estradiol-patch',
    displayName: 'Estradiol: Transdermal Estrogen Support Patch',
    shortName: 'Estradiol Patch',
    subtitle: 'Provider-directed bioidentical estrogen replacement therapy',
    category: 'womens-hormone-therapy',
    goals: ['hrt-women'],
    shortDescription: 'A transdermal estradiol patch prescribed as part of provider-directed hormone therapy, potentially used to support menopausal symptom relief, bone density, hot flash reduction, mood stability, and cardiovascular wellness under clinical supervision.',
    longDescription: RX_DISCLAIMER,
    image: IMG_PATCH,
    imageAlt: 'Estradiol transdermal patch for bioidentical estrogen replacement therapy',
  ...
  mk({
    ...
    displayName: 'Progesterone: Oral Hormone Balance Capsules',
    shortName: 'Progesterone',
    subtitle: 'Provider-directed bioidentical progesterone replacement therapy',
    category: 'womens-hormone-therapy',
    goals: ['hrt-women'],
    shortDescription: 'Oral progesterone capsules prescribed as part of provider-directed hormone therapy, potentially used to support sleep quality, mood balance, menstrual cycle regulation, endometrial protection during estrogen therapy, and menopausal symptom relief under clinical supervision.',
    longDescription: RX_DISCLAIMER,
    image: IMG_CAPSULE,
    imageAlt: 'Progesterone capsules for bioidentical hormone balance therapy',
    providerDisclaimer: RX_DISCLAIMER,
    variants: [
      {
  ...
  mk({
    ...
    displayName: 'Testosterone: Topical Hormone Support Cream',
    shortName: 'Testosterone Cream',
    subtitle: 'Provider-directed bioidentical testosterone replacement therapy',
    category: 'womens-hormone-therapy',
    goals: ['hrt-women'],
    shortDescription: 'A provider-directed topical testosterone cream, potentially used to support libido, energy levels, muscle tone, mood, and sexual wellness as part of a personalized women\'s hormone therapy plan under clinical supervision.',
    longDescription: RX_DISCLAIMER,
    image: IMG_CREAM,
    imageAlt: 'Testosterone topical cream for bioidentical hormone support therapy',
    providerDisclaimer: RX_DISCLAIMER,
    variants: [
      {
  ...
  mk({
    id: 'p83',
    slug: 'scream-cream',
    displayName: 'Scream Cream: Women\'s Sexual Wellness Topical',
    shortName: 'Scream Cream',
    subtitle: 'Provider-directed compounded women\'s sexual wellness topical',
    category: 'womens-hormone-therapy',
    goals: ['hrt-women'],
    shortDescription:
      'A provider-directed compounded topical for women\'s sexual wellness, potentially used to support arousal, sensitivity, lubrication, and intimate comfort under clinical supervision.',
    longDescription: RX_DISCLAIMER,
    image: IMG_CREAM,
    imageAlt: 'Scream Cream compounded topical for women\'s sexual wellness',
    providerDisclaimer: RX_DISCLAIMER,
    variants: [
      {
  ...
  mk({
    ...
    slug: 'nad-plus',
    displayName: 'NAD+: Cellular Energy & Longevity Coenzyme',
    shortName: 'NAD+',
    subtitle: 'Provider-directed NAD+ coenzyme for cellular energy and longevity support',
    category: 'longevity-cognitive',
    goals: ['longevity'],
    shortDescription: 'Provider-directed NAD+ injection and nasal spray options, potentially used to support cellular energy production, mitochondrial function, DNA repair, cognitive clarity, and healthy aging under clinical supervision.',
    longDescription: COMPOUNDED_DISCLAIMER,
    image: IMG_NASAL,
    imageAlt: 'NAD+ coenzyme injection and nasal spray for cellular energy and longevity support',
    providerDisclaimer: COMPOUNDED_DISCLAIMER,
    bestSeller: true,
    variants: [
  ...
  mk({
    ...
    slug: 'selank',
    displayName: 'Selank: Calm-Focus & Stress Support Injection',
    shortName: 'Selank',
    subtitle: 'Provider-directed compounded anxiolytic peptide for calm and focus support',
    category: 'longevity-cognitive',
    goals: ['longevity', 'focus'],
    shortDescription: 'A provider-directed compounded Selank peptide injection, potentially used to support stress resilience, calm-focus states, anxiety-related wellness goals, cognitive clarity, and emotional balance under clinical supervision.',
    longDescription: COMPOUNDED_DISCLAIMER,
    image: IMG_INJECTION,
    imageAlt: 'Selank peptide injection for calm-focus and stress support',
    providerDisclaimer: COMPOUNDED_DISCLAIMER,
    variants: [
  ...
  mk({
    ...
    slug: 'semax',
    displayName: 'Semax: Cognitive Focus & Memory Support Injection',
    shortName: 'Semax',
    subtitle: 'Provider-directed compounded nootropic peptide for cognitive enhancement support',
    category: 'longevity-cognitive',
    goals: ['longevity', 'focus'],
    shortDescription: 'A provider-directed compounded Semax peptide injection, potentially used to support focus, attention, memory consolidation, cognitive performance, neuroprotection, and mental clarity under clinical supervision.',
    longDescription: COMPOUNDED_DISCLAIMER,
    image: IMG_INJECTION,
    imageAlt: 'Semax peptide injection for cognitive focus and memory support',
    providerDisclaimer: COMPOUNDED_DISCLAIMER,
    variants: [
      { dosageForm: 'Injection', strength: 'Provider-directed', size: 'Monthly supply', price: 129 },
    ],
  ...
  mk({
    ...
    displayName: 'Selank + Semax: Calm-Focus & Cognitive Nasal Spray',
    shortName: 'Selank + Semax Nasal',
    subtitle: 'Provider-directed compounded dual-peptide nasal spray for calm-focus and cognitive support',
    category: 'longevity-cognitive',
    goals: ['longevity', 'focus'],
    shortDescription: 'A provider-directed compounded Selank and Semax dual-peptide nasal spray, potentially used to support combined calm-focus states, stress resilience, cognitive clarity, memory, and emotional balance in a needle-free format under clinical supervision.',
    longDescription: COMPOUNDED_DISCLAIMER,
    image: IMG_NASAL,
    imageAlt: 'Selank and Semax dual-peptide nasal spray for calm-focus and cognitive support',
    providerDisclaimer: COMPOUNDED_DISCLAIMER,
    variants: [
      {
  ...
  mk({
    id: 'p73',
    slug: 'tesamorelin',
    displayName: 'Tesamorelin: GHRH Metabolic & Body-Composition Injection',
    shortName: 'Tesamorelin',
    subtitle: 'Provider-directed growth hormone-releasing hormone analog for metabolic support',
    category: 'longevity-cognitive',
    goals: ['longevity'],
    shortDescription:
      'A provider-directed compounded Tesamorelin injection (growth hormone-releasing factor analog), potentially used to support growth hormone release, visceral fat reduction, lean body composition, lipid metabolism, and metabolic wellness under clinical supervision.',
    longDescription: COMPOUNDED_DISCLAIMER,
    image: IMG_INJECTION,
    imageAlt: 'Tesamorelin GHRH injection for metabolic and body-composition support',
    providerDisclaimer: COMPOUNDED_DISCLAIMER,
    // Visible for browse; checkout remains unavailable until routing/payment is ready.
    status: 'active',
    isVisible: true,
  ...
  mk({
    id: 'p82',
    slug: 'recovery-stack',
    displayName: 'KLOW: Four-Peptide Tissue Repair & Recovery Blend',
    shortName: 'KLOW',
    subtitle: 'Provider-directed compounded four-peptide recovery and tissue-repair blend',
    category: 'recovery-performance',
    goals: ['recovery', 'performance'],
    shortDescription:
      'A provider-directed compounded four-peptide recovery injection (BPC-157, GHK-Cu, KPV, TB-500), potentially used to support musculoskeletal recovery, tissue repair, inflammation modulation, wound healing, and athletic performance wellness. Medication price is $159 plus $30 shipping at checkout.',
    longDescription: COMPOUNDED_DISCLAIMER,
    image: IMG_INJECTION,
    imageAlt: 'Amber injection vial for KLOW four-peptide tissue repair and recovery blend',
    providerDisclaimer: COMPOUNDED_DISCLAIMER,
    memberPricingEligible: false,
  ...
  mk({
    ...
    displayName: 'Tretinoin: Prescription Skin Renewal Cream',
    shortName: 'Tretinoin',
    subtitle: 'Provider-directed retinoid for acne, texture, and anti-aging skin care',
    category: 'prescription-skin-hair',
    goals: ['beauty'],
    shortDescription: 'A prescription topical tretinoin cream, potentially used to support acne treatment, skin cell turnover, fine line and wrinkle reduction, uneven skin texture improvement, hyperpigmentation, and photoaging repair under clinical supervision.',
    longDescription: RX_DISCLAIMER,
    image: IMG_CREAM,
    imageAlt: 'Tretinoin prescription retinoid cream for skin renewal and acne treatment',
    providerDisclaimer: RX_DISCLAIMER,
    bestSeller: true,
    variants: [
      {
  ...
  mk({
    ...
    displayName: 'Minoxidil: Topical Hair Regrowth Solution',
    shortName: 'Minoxidil Topical',
    subtitle: 'Provider-directed topical for androgenetic alopecia and thinning hair',
    category: 'prescription-skin-hair',
    goals: ['beauty'],
    shortDescription: 'A provider-directed compounded topical minoxidil solution, potentially used to support hair follicle stimulation, increased blood flow to scalp tissue, thinning hair management, androgenetic alopecia treatment, and visible hair density improvement under clinical supervision.',
    longDescription:
    ...
    image: IMG_GEL,
    imageAlt: 'Minoxidil compounded topical solution for hair regrowth and thinning hair',
    providerDisclaimer:
  ...
  mk({
    ...
    displayName: 'Bimatoprost: Lash & Brow Growth Serum',
    shortName: 'Bimatoprost',
    subtitle: 'Provider-directed prostamide for eyelash and brow enhancement',
    category: 'prescription-skin-hair',
    goals: ['beauty'],
    shortDescription: 'A prescription bimatoprost solution, potentially used to support eyelash length, thickness, and darkness enhancement, as well as brow fullness and appearance improvement under clinical supervision.',
    longDescription: RX_DISCLAIMER,
    image: IMG_SPRAY,
    imageAlt: 'Bimatoprost prescription lash and brow growth serum',
    providerDisclaimer: RX_DISCLAIMER,
    needsDedicatedImage: true,
    internalNotes:
  ...
  mk({
    ...
    goals: ['hrt-women'],
    shortDescription:
      'Choose a current in-home or walk-in lab option when labs are required for Women’s Hormone Therapy review.',
    longDescription:
      'Choose a current in-home or walk-in lab option when labs are required for Women’s Hormone Therapy review. Lab ordering, intake, payment, and results are handled through the secure clinical lab workflow. This is not a medication.',
    image: 'https://images.pexels.com/photos/6129507/pexels-photo-6129507.jpeg?auto=compress&cs=tinysrgb&w=1200',
    ...
    providerDisclaimer:
      'Hormone therapy labs are selected and paid through the secure clinical lab workflow when required.',
  }),
  ...
  mk({
    ...
    shortDescription: 'The ultimate starter kit: Premium Protective Medication Case, temperature-controlled travel case, discreet travel bag, reusable ice pack, wellness planner, sharps container, alcohol prep wipes, and insulin syringes — all in one. Save $71 versus buying each item separately.',
    longDescription: 'The ultimate starter kit: Premium Protective Medication Case, temperature-controlled travel case, discreet travel bag, reusable ice pack, wellness planner, sharps container, alcohol prep wipes, and insulin syringes — all in one.',
  ...
  mk({
    ...
    displayName: 'Premium Protective Medication Case',
    shortName: 'Protective Case',
    subtitle: 'Elevated protection for your wellness essentials',
    category: 'accessories',
    goals: ['daily-wellness'],
    shortDescription:
    ...
    longDescription:
      'A durable protective case designed to keep your wellness essentials organized, protected, and discreet at home or while traveling. Its structured construction helps protect your supplies while maintaining the clean, elevated aesthetic of My Bare Method.',
    image: IMG_3D_CASE,
    imageAlt: 'Premium protective medication case',
  ...
  mk({
    ...
    slug: 'sermorelin',
    displayName: 'Sermorelin: Growth Hormone-Releasing Peptide',
    shortName: 'Sermorelin',
    subtitle: 'Provider-directed GHRH analog for growth hormone support and anti-aging wellness',
    category: 'longevity-cognitive',
    goals: ['longevity'],
    shortDescription: 'A provider-directed compounded Sermorelin injection, potentially used to support natural growth hormone release, sleep quality, body composition, tissue repair, immune function, and healthy aging under clinical supervision.',
    longDescription: COMPOUNDED_DISCLAIMER,
    image: IMG_INJECTION,
    imageAlt: 'Sermorelin GHRH peptide injection for growth hormone and anti-aging support',
    providerDisclaimer: COMPOUNDED_DISCLAIMER,
    status: 'future',
    isVisible: false,
    launchPhase: 2,
  ...
  mk({
    ...
    displayName: 'Minoxidil: Oral Hair Regrowth Tablets',
    shortName: 'Minoxidil Tablets',
    subtitle: 'Provider-directed oral medication for androgenetic alopecia and hair loss',
    category: 'prescription-skin-hair',
    goals: ['beauty'],
    shortDescription: 'Provider-directed oral minoxidil tablets, potentially used to support hair follicle stimulation, diffuse hair loss management, androgenetic alopecia treatment, and overall hair density improvement from a systemic approach under clinical supervision.',
    longDescription: RX_DISCLAIMER,
    image: IMG_CAPSULE,
    imageAlt: 'Minoxidil oral tablets for systemic hair regrowth and alopecia treatment',
    providerDisclaimer: RX_DISCLAIMER,
    status: 'future',
    isVisible: false,
    launchPhase: 2,
...
export const memberships: Membership[] = [
  {
    ...
    displayName: 'Semaglutide Membership: Flat-Rate GLP-1 Weight Management Program',
  ...
  },
  {
    ...
    displayName: 'Tirzepatide Membership: Flat-Rate Dual GLP-1/GIP Weight Management Program',
