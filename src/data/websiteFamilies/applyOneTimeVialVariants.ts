  ...
  return {
    ...
    startingAtPriceDisplay:
      family.familyId === 'semaglutide'
        ? 'Starting at $89 (vial-specific one-time); Membership $149'
        : family.familyId === 'tirzepatide'
          ? 'Starting at $119 (vial-specific one-time); Membership $275'
          : family.startingAtPriceDisplay,
    variants: family.variants.map((v) => {
      if (v.websiteVariantId === 'sem-b12-starting-low') {
        return { ...v, displayLabel: 'Vitamin B12', finalRetailPrice: 89, startingPrice: 89, exactFormularyRows: [3] };
      }
      if (v.websiteVariantId === 'sem-b12-mid') {
        return { ...v, displayLabel: 'Vitamin B12', finalRetailPrice: 109, startingPrice: 109, exactFormularyRows: [7] };
      }
      if (v.websiteVariantId === 'sem-b12-high') {
        return { ...v, displayLabel: 'Vitamin B12', finalRetailPrice: 109, startingPrice: 109, exactFormularyRows: [9] };
      }
      if (v.websiteVariantId === 'sem-glycine-starting-low') {
        return { ...v, displayLabel: 'Glycine', finalRetailPrice: 89, startingPrice: 89, exactFormularyRows: [2] };
      }
      if (v.websiteVariantId === 'sem-glycine-mid') {
        return { ...v, displayLabel: 'Glycine', finalRetailPrice: 109, startingPrice: 109, exactFormularyRows: [6] };
      }
      if (v.websiteVariantId === 'sem-glycine-high') {
        return { ...v, displayLabel: 'Glycine', finalRetailPrice: 109, startingPrice: 109, exactFormularyRows: [8] };
      }
      if (v.websiteVariantId === 'tir-b12-starting-low') {
        return { ...v, displayLabel: 'Vitamin B12', finalRetailPrice: 119, startingPrice: 119, exactFormularyRows: [14] };
      }
      if (v.websiteVariantId === 'tir-b12-mid') {
        return { ...v, displayLabel: 'Vitamin B12', finalRetailPrice: 149, startingPrice: 149, exactFormularyRows: [18] };
      }
      if (v.websiteVariantId === 'tir-b12-high') {
        return { ...v, displayLabel: 'Vitamin B12', finalRetailPrice: 169, startingPrice: 169, exactFormularyRows: [22] };
      }
      if (v.websiteVariantId === 'tir-glycine-starting-low') {
        return { ...v, displayLabel: 'Glycine', finalRetailPrice: 119, startingPrice: 119, exactFormularyRows: [13] };
      }
      if (v.websiteVariantId === 'tir-glycine-mid') {
        return { ...v, displayLabel: 'Glycine', finalRetailPrice: 149, startingPrice: 149, exactFormularyRows: [17] };
      }
      if (v.websiteVariantId === 'tir-glycine-high') {
        return { ...v, displayLabel: 'Glycine', finalRetailPrice: 169, startingPrice: 169, exactFormularyRows: [21] };
      }
      return v;
    }),
  };
