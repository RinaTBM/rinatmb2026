 ...
 * Postcheck: docs/MBM_GEN_PAIRING_POSTCHECK_3.md
 *
...
/**
 * Live-verified GEN clientProductIds (MBM-GEN-PAIRING-POSTCHECK-3).
 * Re-derived from current GEN formulary read — not stale prior audits.
 */
