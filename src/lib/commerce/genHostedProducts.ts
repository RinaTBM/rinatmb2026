export const GEN_HOSTED_PRODUCTS: Record<string, { price: number; genClientProductId: string }> = {
  ...
  'tretinoin-cream': { price: 80, genClientProductId: 'f5e0mdyBYnDh7HGvek0C_MoDyAcICE5RDa4DfaeBX_EeWMcfCJf5EU2LkNQmp9' },
  ...
  'ondansetron-odt': { price: 60, genClientProductId: 'f5e0mdyBYnDh7HGvek0C_MoDyAcICE5RDa4DfaeBX_4ZWsN26iLt5ZpiLS1HCC' },
