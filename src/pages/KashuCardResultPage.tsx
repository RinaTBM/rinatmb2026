        ...
        <div className="card-lux p-6 text-left mb-6 space-y-3">
          <div className="flex items-start gap-3">
            ...
            <p className="text-sm text-ink-600">
              Card payments are processed securely by Kashu. This page does not finalize payment by
              itself — confirmation comes from Kashu’s verified server notification.
            </p>
          </div>
        </div>
