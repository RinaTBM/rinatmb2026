          ...
          body: (
            <>
              ...
              <LegalBulletList items={[
                ...
                'Payment information: billing name and address, and card details processed securely through Stripe. We do not store full card numbers on our servers.',
          ...
          body: (
            <>
              <p>
                ...
                perform their duties. We use encryption in transit (TLS) and at rest. Payment data is handled
                exclusively by Stripe, a PCI-DSS compliant payment processor, and is never stored on our infrastructure.
              </p>
              <p>
        ...
        },
        {
          ...
          body: (
            <>
              ...
              <LegalBulletList items={[
                'Stripe: processes payments. Receives your billing details and card information. Governed by Stripe\'s privacy policy and PCI-DSS standards.',
